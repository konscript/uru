...
--
-- Host: mysql1052.servage.net
-- Generation Time: Jan 14, 2011 at 07:22 PM
...
-- Database: `uru-oc`
--
CREATE DATABASE `uru-oc` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `uru-oc`;
...
(1, 1, 'Konscript', 'Søren', 'Louv-Jansen', 'Sølvgade 95', '', '2323', 'København', 57, 904);
...
(37, '', 0, 0, '2011-01-12 13:47:44', '2011-01-12 13:47:44', 1),
(38, '', 0, 0, '2011-01-12 13:48:00', '2011-01-12 13:48:00', 1),
(36, '', 0, 0, '2011-01-12 13:47:19', '2011-01-12 13:47:27', 1),
(35, '', 0, 0, '2011-01-12 13:46:56', '2011-01-12 13:46:56', 1);
...
INSERT INTO `category_description` (`category_id`, `language_id`, `name`, `meta_keywords`, `meta_description`, `description`) VALUES
(35, 1, 'Bracelets', '', '', ''),
(36, 1, 'Cufflinks &amp; Rings', '', '', ''),
(37, 1, 'Necklace &amp; Pendants', '', '', ''),
(38, 1, 'URU Master Pieces', '', '', '');
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 1.00000000, 1, '2011-01-14 18:41:07'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.58739996, 1, '2011-01-14 18:41:06'),
(3, 'Euro', 'EUR', '', '€', '2', 1.18939996, 1, '2011-01-14 18:41:07');
...
INSERT INTO `customer` (`customer_id`, `store_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `password`, `cart`, `newsletter`, `address_id`, `status`, `approved`, `customer_group_id`, `ip`, `date_added`) VALUES
(1, 0, 'Søren', 'Louv-Jansen', 'sorenlouv@gmail.com', '4551749555', '', '8541fd9136ff679d72e2a0f996276db9', 'a:0:{}', 0, 1, 1, 1, 8, '127.0.0.1', '2010-12-12 17:41:24');
...
INSERT INTO `order_option` (`order_option_id`, `order_id`, `order_product_id`, `product_option_value_id`, `name`, `value`, `price`, `prefix`) VALUES
(1, 1, 1, 586, 'Memory', '1GB', '100.0000', '+'),
(2, 1, 3, 587, 'Memory', '8GB', '150.0000', '+');
...
INSERT INTO `order_product` (`order_product_id`, `order_id`, `product_id`, `name`, `model`, `price`, `total`, `tax`, `quantity`) VALUES
(1, 1, 48, 'iPod Classic', 'product 20', '100.0000', '700.0000', '0.0000', 7),
(2, 1, 47, 'HP LP3065', 'Product 21', '1000.0000', '2000.0000', '0.0000', 2),
(3, 1, 48, 'iPod Classic', 'product 20', '150.0000', '150.0000', '0.0000', 1),
(4, 1, 29, 'Palm Treo Pro', 'Product 2', '279.9900', '279.9900', '0.0000', 1);
...
INSERT INTO `order_total` (`order_total_id`, `order_id`, `title`, `text`, `value`, `sort_order`) VALUES
(1, 1, 'Sub-Total:', '£3,129.99', '3129.9900', 1),
(2, 1, 'Flat Rate:', '£2.00', '2.0000', 3),
(3, 1, 'Total:', '£3,131.99', '3131.9900', 6);
...
INSERT INTO `product` (`product_id`, `model`, `sku`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `status`, `date_added`, `date_modified`, `viewed`, `sort_order`, `subtract`, `minimum`, `cost`) VALUES
(49, 'demo123', '', '', 1, 5, '', 11, 1, '0.0000', 0, '2011-01-11', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, '2011-01-12 13:49:46', '0000-00-00 00:00:00', 1, 1, 1, 1, '0.0000');
...
INSERT INTO `product_description` (`product_id`, `language_id`, `name`, `meta_keywords`, `meta_description`, `description`) VALUES
(49, 1, 'Demo', '', '', '');
...
INSERT INTO `product_featured` (`product_id`) VALUES
(42),
(28),
(43),
(44),
...
INSERT INTO `product_tags` (`product_id`, `tag`, `language_id`) VALUES
(49, '', 1);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1005 ;
...
(2, 'shipping', 'shipping_sort_order', '3'),
(3, 'shipping', 'shipping_status', '1'),
...
(11, 'tax', 'tax_status', '1'),
(12, 'tax', 'tax_sort_order', '5'),
(13, 'total', 'total_sort_order', '6'),
(14, 'total', 'total_status', '1'),
(15, 'category', 'category_sort_order', '1'),
(16, 'category', 'category_status', '1'),
(17, 'information', 'information_sort_order', '3'),
(18, 'information', 'information_status', '1'),
(19, 'information', 'information_position', 'left'),
(996, 'manufacturer', 'manufacturer_sort_order', '2'),
(995, 'manufacturer', 'manufacturer_status', '0'),
(1004, 'bestseller', 'bestseller_sort_order', '3'),
(1003, 'bestseller', 'bestseller_status', '0'),
(1002, 'bestseller', 'bestseller_position', 'right'),
(1001, 'bestseller', 'bestseller_limit', '10'),
(999, 'featured', 'featured_status', '0'),
(998, 'featured', 'featured_position', 'right'),
(997, 'featured', 'featured_limit', '5'),
(30, 'cart', 'cart_status', '1'),
(31, 'category', 'category_position', 'left'),
(994, 'manufacturer', 'manufacturer_position', 'left'),
(33, 'cart', 'cart_position', 'right'),
(34, 'cart', 'cart_ajax', '1'),
(35, 'cart', 'cart_sort_order', '1'),
(1000, 'featured', 'featured_sort_order', '5'),
(993, 'config', 'config_error_filename', 'error.txt'),
(992, 'config', 'config_error_log', '1'),
(991, 'config', 'config_error_display', '1'),
(990, 'config', 'config_compression', '0'),
(989, 'config', 'config_seo_url', '0'),
(988, 'config', 'config_encryption', '12345'),
(987, 'config', 'config_maintenance', '0'),
(986, 'config', 'config_ssl', '0'),
(985, 'config', 'config_alert_emails', ''),
(983, 'config', 'config_smtp_timeout', '5'),
(984, 'config', 'config_alert_mail', '0'),
(982, 'config', 'config_smtp_port', '25'),
(981, 'config', 'config_smtp_password', ''),
(980, 'config', 'config_smtp_username', ''),
(979, 'config', 'config_smtp_host', ''),
(978, 'config', 'config_mail_parameter', ''),
(977, 'config', 'config_mail_protocol', 'mail'),
(976, 'config', 'config_image_cart_height', '75'),
(975, 'config', 'config_image_cart_width', '75'),
(974, 'config', 'config_image_related_height', '120'),
(973, 'config', 'config_image_related_width', '120'),
(972, 'config', 'config_image_additional_height', '150'),
(971, 'config', 'config_image_additional_width', '150'),
(970, 'config', 'config_image_product_height', '120'),
(969, 'config', 'config_image_product_width', '120'),
(968, 'config', 'config_image_category_height', '120'),
(967, 'config', 'config_image_category_width', '120'),
(78, 'flat', 'flat_cost', '2'),
(79, 'flat', 'flat_tax_class_id', '9'),
(80, 'flat', 'flat_geo_zone_id', '0'),
(81, 'flat', 'flat_status', '1'),
(82, 'flat', 'flat_sort_order', '1'),
(966, 'config', 'config_image_popup_height', '500'),
(965, 'config', 'config_image_popup_width', '500'),
(964, 'config', 'config_image_thumb_height', '250'),
(961, 'config', 'config_logo', 'data/uruLogo.jpg'),
(962, 'config', 'config_icon', 'data/cart.png'),
(963, 'config', 'config_image_thumb_width', '250'),
(960, 'config', 'config_shipping_session', '0'),
(959, 'config', 'config_cart_weight', '1'),
(958, 'config', 'config_download_status', '5'),
(957, 'config', 'config_download', '1'),
(956, 'config', 'config_review', '1'),
(955, 'config', 'config_stock_status_id', '5'),
(954, 'config', 'config_order_status_id', '1'),
(953, 'config', 'config_stock_checkout', '0'),
(952, 'config', 'config_stock_warning', '0'),
(951, 'config', 'config_stock_display', '0'),
(950, 'config', 'config_checkout_id', '5'),
(949, 'config', 'config_account_id', '3'),
(948, 'config', 'config_guest_checkout', '1'),
(947, 'config', 'config_customer_approval', '0'),
(113, 'latest', 'latest_limit', '8'),
(114, 'latest', 'latest_position', 'home'),
(115, 'latest', 'latest_status', '1'),
(116, 'latest', 'latest_sort_order', '0'),
(946, 'config', 'config_customer_price', '0'),
(945, 'config', 'config_customer_group_id', '8'),
(943, 'config', 'config_invoice_id', '001'),
(944, 'config', 'config_invoice_prefix', 'INV'),
(942, 'config', 'config_tax', '1'),
(941, 'config', 'config_catalog_limit', '20'),
(940, 'config', 'config_admin_limit', '20'),
(939, 'config', 'config_weight_class', 'kg'),
(938, 'config', 'config_length_class', 'cm'),
(937, 'config', 'config_currency_auto', '1'),
(936, 'config', 'config_currency', 'GBP'),
(935, 'config', 'config_admin_language', 'en'),
(934, 'config', 'config_language', 'en'),
(933, 'config', 'config_country_id', '57'),
(932, 'config', 'config_description_1', ''),
(931, 'config', 'config_template', 'konscript'),
(930, 'config', 'config_meta_description', 'My Store'),
(929, 'config', 'config_title', 'URU'),
(928, 'config', 'config_fax', ''),
(927, 'config', 'config_telephone', '123456789'),
(925, 'config', 'config_address', 'Sølvgade 95'),
(926, 'config', 'config_email', 'sorenlouv@gmail.com'),
(924, 'config', 'config_owner', 'Søren Louv-Jansen'),
(923, 'config', 'config_url', 'http://uru.konscript.com/'),
(922, 'config', 'config_name', 'URU Diamonds');
...
(1, 1, 'admin', 'e2560f73579c206926f0b121939640f6', 'Konscript', 'Admin', 'admin@konscript.com', 1, '', '2011-01-14 18:35:23');
