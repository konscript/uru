...
<div id="content">
  ...
  <div class="middle">
        ...
        <tr>
          ...
          <td style="padding-left: 15px; width: 296px; vertical-align: top;"><table width="100%">
            ...
            <form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="product">
              ...
              <div style="background: #666; border: 1px solid #888; padding: 10px; margin-top: 2px; margin-bottom: 15px;">
              ...
              <div style="border: 1px solid #444; padding: 10px; margin-top: 2px; margin-bottom: 15px;">
                <table style="width: 100%;">
                  <tr>
    ...
    <div id="tab_related" class="tab_page" style="display: none">
      ...
      <?php } else { ?>
      <div style="border: 1px solid #444; padding: 10px; margin-bottom: 10px;"><?php echo $text_no_related; ?></div>
      <?php } ?>
    </div>
  </div>
  <div class="bottom">
